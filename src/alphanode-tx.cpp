...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Alphanode Core alphanode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  alphanode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded alphanode transaction") + "\n" +
                               "  alphanode-tx [options] -create [commands]   " + _("Create hex-encoded alphanode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded alphanode transaction
