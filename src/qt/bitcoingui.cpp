                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Alphanode-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Alphanode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alphanode: URIs)"));
...
//AAAA LimxDev Coinmix Tab	
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Alphanode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Alphanode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Alphanode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Alphanode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alphanode addresses"));
    ...
    openAction->setStatusTip(tr("Open a Alphanode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Alphanode Core help message to get a list with possible Alphanode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Alphanode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Alphanode network", "", count));
}
...
{
    QString strTitle = tr("Alphanode Core"); // default title
