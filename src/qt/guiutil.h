...
/** Utility functions used by the ALN Qt UI.
 */
namespace GUIUtil
{
...
// Render ALN addresses in monospace font
...
// Parse "alphanode:" URI into recipient object, return true on successful parsing
