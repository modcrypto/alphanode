...
void Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Alphanode Core"),
     ...
     * override -datadir in the alphanode.conf file in the default data directory
     * (to be consistent with alphanoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
