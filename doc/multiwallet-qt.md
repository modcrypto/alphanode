...
In order to support loading of multiple wallets in alphanode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is alphanode.cpp.
...
Changes to alphanode.cpp
----------------------
alphanode.cpp is the entry point into alphanode-qt, and as such, will require some minor modifications to provide hooks for
