...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/alphanode-cli.cpp \
           src/alphanode-tx.cpp \
           src/alphanode.cpp \
           src/db.cpp \
           ...
           src/qt/alphanode.cpp \
           src/qt/alphanodestrings.cpp \
...
RESOURCES += src/qt/alphanode.qrc src/qt/alphanode_locale.qrc

TRANSLATIONS += src/qt/locale/alphanode_bg.ts \
                src/qt/locale/alphanode_de.ts \
                src/qt/locale/alphanode_en.ts \
                src/qt/locale/alphanode_es.ts \
                src/qt/locale/alphanode_fi.ts \
                src/qt/locale/alphanode_fr.ts \
                src/qt/locale/alphanode_it.ts \
                src/qt/locale/alphanode_ja.ts \
                src/qt/locale/alphanode_pl.ts \
                src/qt/locale/alphanode_pt.ts \
                src/qt/locale/alphanode_ru.ts \
                src/qt/locale/alphanode_sk.ts \
                src/qt/locale/alphanode_sv.ts \
                src/qt/locale/alphanode_vi.ts \
                src/qt/locale/alphanode_zh_CN.ts \
                src/qt/locale/alphanode_zh_TW.ts
